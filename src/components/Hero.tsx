...
const Hero = () => {
  return (
    <header className="bg-heroImgSm md:bg-heroImgMd xl:bg-heroImgLg h-[70vh] bg-cover bg-center bg-no-repeat min-[400px]:h-[75vh] min-[480px]:h-[85vh] sm:h-[95vh] lg:h-screen">
