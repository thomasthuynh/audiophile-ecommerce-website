...
const CategoryProduct = ({ product, image }: Props) => {
  return (
    <div className="my-16 rounded-md bg-gray-300 min-[480px]:my-24 md:w-[32%]">
      <div className="flex -translate-y-[30%] flex-col items-center">
        ...
        <div className="-mb-4 lg:-mb-8 xl:-mb-10">
          ...
          <button className="mx-auto mt-2 flex items-center text-xs font-bold uppercase text-neutral-500 xl:text-base">
            Shop
            <span className="ml-2">
