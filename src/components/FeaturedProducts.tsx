  ...
  return (
    <main className="py-8">
      <div className="mx-auto grid w-5/6 gap-12">
        {/* ZX9 SPEAKER */}
        <div className="bg-primary-500 bg-circles overflow-hidden rounded-md bg-[length:525px_525px] bg-[center_top_-100px] bg-no-repeat px-8 py-20 md:bg-[length:775px_775px] md:bg-[center_top_-150px] lg:bg-[left_-175px_top_0px] lg:py-8 xl:bg-[length:925px_925px] min-[1440px]:bg-[length:1025px_1025px] min-[1440px]:bg-[left_-150px_top_0px]">
