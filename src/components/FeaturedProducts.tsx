  ...
  return (
    <main className="py-8">
      <div className="mx-auto grid w-5/6 gap-12 md:grid-cols-2">
        {/* ZX9 SPEAKER */}
        <div className="bg-primary-500 bg-circles overflow-hidden rounded-md bg-[length:525px_525px] bg-[center_top_-100px] bg-no-repeat px-8 py-20 md:col-span-2 md:bg-[length:775px_775px] md:bg-[center_top_-150px] lg:bg-[left_-175px_top_0px] lg:py-8 xl:bg-[length:925px_925px] min-[1440px]:bg-[length:1025px_1025px] min-[1440px]:bg-[left_-150px_top_0px]">
          <div className="mx-auto flex flex-col items-center justify-center lg:flex-row lg:justify-around min-[1440px]:w-[90%]">
            {/* IMAGE */}
            <div className="mx-auto w-3/5 pb-6 sm:w-2/5 lg:translate-y-[20%] xl:w-2/5 xl:translate-y-[15%]">
              <img
                src={getImageSize("primarySpeaker")}
                alt="ZX9 Speaker"
                className="lg:max-w-[285px] xl:max-w-[400px]"
              />
            </div>

            {/* TEXT AND BUTTON*/}
            <div className="text-center lg:w-1/2 lg:items-start lg:px-4 lg:text-left xl:mx-auto xl:w-2/5">
              ...
              <button className="transparent bg-black px-6 py-3 text-sm uppercase tracking-[1px] text-white hover:bg-neutral-700 sm:px-8 sm:py-4 sm:text-base lg:px-6 lg:py-3">
                See Product
              </button>
            </div>
          </div>
