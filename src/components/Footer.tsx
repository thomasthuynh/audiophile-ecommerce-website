...
const Footer = ({ selectedPage, setSelectedPage }: Props) => {
  return (
    <footer className="relative bg-black text-white">
      <div className="relative mx-auto h-full w-5/6 pb-8 pt-12 xl:pt-20 xl:pb-12">
        ...
        <div className="flex items-end xl:justify-between">
          <p className="text-center text-sm text-neutral-400 md:text-start xl:w-1/2">
        ...
        <div className="flex flex-col items-center justify-between md:flex-row md:pt-20">
          <p className="py-12 text-sm font-bold text-neutral-400 md:py-0">
