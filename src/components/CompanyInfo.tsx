  ...
  return (
    <section className="py-24">
      <div className="mx-auto grid w-5/6 gap-8 xl:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-md xl:order-2 max-w-[580px]">
          <picture>
            <source media="(min-width: 1280px)" srcSet={BestGearLg}/>
            <source media="(min-width: 768px)" srcSet={BestGearMd} />
            <img src={BestGearSm} alt="Man wearing headphones" className="w-full"/>
          </picture>
        </div>

        <div className="flex-col justify-center text-center xl:flex xl:text-left  xl:w-4/5">
