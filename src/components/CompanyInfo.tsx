...
const CompanyInfo = (props: Props) => {
  return (
    <section className="py-24">
      <div className="mx-auto w-5/6 grid gap-8 xl:grid-cols-2">
 
          <div className="overflow-hidden rounded-md xl:order-2 2xl:w-4/5 2xl:mx-auto">
            <picture>
          ...
          <div className="flex-col justify-center text-center xl:flex xl:w-4/5  xl:text-left 2xl:mx-auto">
